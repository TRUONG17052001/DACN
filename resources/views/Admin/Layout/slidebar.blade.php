<div class="sidebar sidebar-hide-to-small sidebar-shrink sidebar-gestures">
        <div class="nano">
            <div class="nano-content">
                <ul>
                    <li><div class="logo"><a href="/admin"><span>Men's Shop</span></a></div><li>
                    <li class="label">Trang chủ</li>
                    <li><a class="sidebar-sub-toggle"><i class="ti-home"></i> Bảng điều khiển
                    ...
                    <li><a class="sidebar-sub-toggle"><i class="ti-layout-grid4-alt"></i> Quản lý <span
                                class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <ul>
                            <!-- <li><a href="table-basic.html">Basic</a></li>
                            <li><a href="table-export.html">Datatable Export</a></li> -->
                            <li><a href="/tableSP">Danh sách sản phẩm</a></li>
                            <li><a href="/tableDM">Danh sách danh mục</a></li>
                            <li><a href="/tableCTHD">Danh sách chi tiết hóa đơn</a></li>
                            <li><a href="/tableHD">Danh sách hóa đơn</a></li>
                            <li><a href="/tableND">Danh sách người dùng</a></li>
                        </ul>
                    </li>
