        ...
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="/User/img/{{$Product['anhsp']}}" alt="Image">
                        </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    <form action="/cart/add/{{$Product['masp']}}" method="post">
                        @csrf
                        <h3>{{$Product['tensp']}}</h3>
                        ...
                        <h3 class="font-weight-semi-bold mb-4">{{number_format($Product['giasp'])}} VND</h3>
                        <p class="mb-4">{{$Product['motasp']}}</p>
                        <div class="d-flex mb-3">
                    ...
                    <div class="product-item bg-light">
                        ...
                        <div class="text-center py-4">
                            ...
                            <div class="d-flex align-items-center justify-content-center mt-2">
                                <h5>{{number_format($items->giasp)}} VND</h5>
