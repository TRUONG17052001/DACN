            ...
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        ...
                        <tr>
                            <td class="align-middle"><img src="/User/img/<?php echo e($items->options['img']); ?>" alt="" style="width: 50px;"><?php echo e($items->name); ?></td>
                            <td class="align-middle"><?php echo e(number_format($items->price)); ?> VND</td>
                            <td class="align-middle">
                                <div class="input-group quantity mx-auto" style="width: 100px;">
                                    ...
                                    <input type="text" class="form-control form-control-sm bg-secondary border-0 text-center" value="<?php echo e($items->qty); ?>">
                                    <!-- <div class="input-group-btn">
                            ...
                            <td class="align-middle"><?php echo e($items->options['color']); ?></td>
                            <td class="align-middle"><?php echo e($items->options['size']); ?></td>
                            <td class="align-middle"><?php echo e(number_format($items->price*$items->qty)); ?> VND</td>
                            <td class="align-middle"><a class="btn btn-sm btn-danger" href="/cart/remove/<?php echo e($items->rowId); ?>"><i class="fa fa-times"></i></a></td>
                        </tr>
                ...
                <div class="bg-light p-30 mb-5">
                    <div class="border-bottom pb-2">
                        <div class="d-flex justify-content-between mb-3">
                            <h6>Tạm tính</h6>
                            <h6><?php echo e(cart::subtotal(0)); ?> VND</h6>
                        </div>
...
</html><?php /**PATH D:\Đại học\HK1_ Năm 4\Đồ án chuyên ngành\Lavarel\lavarel-app\resources\views/User/cart.blade.php ENDPATH**/ ?>