                                    ...
                                    <div class="form-validation">
                                        <form class="form-valide" action="/formS/edit/{id}" method="post">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" class="form-control" id="val-username"
                                                        ...
                                                        value="<?php echo e($Product->masp); ?>" required="required" readonly>
                                                </div>
                                            </div>
                                            <!-- <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" class="form-control" id="val-username"
                                                        name="tensp" value="<?php echo e($Product->tensp); ?>"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" class="form-control" id="val-username"
                                                        name="donvitinh" value="<?php echo e($Product->donvitinh); ?>"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="text" class="form-control" id="val-digits" name="giasp"
                                                        value="<?php echo e($Product->giasp); ?>" placeholder="500,000" required="required">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                    <textarea class="form-control" id="val-suggestions" name="motasp"
                                                        rows="5" value="1"
                                                        placeholder="<?php echo e($Product->motasp); ?>"></textarea>
                                                </div>
                                            </div>
                                            <!-- <div class="form-group row">
...
</html><?php /**PATH D:\Đại học\HK1_ Năm 4\Đồ án chuyên ngành\Lavarel\lavarel-app\resources\views/Admin/formS.blade.php ENDPATH**/ ?>