                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" class="form-control" id="val-username"
                                                        ...
                                                        value="<?php echo e($Cate->madm); ?>" required="required" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" class="form-control" id="val-username"
                                                        name="tendm" value="<?php echo e($Cate->tendm); ?>"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="text" class="form-control" id="val-digits" name="soluong"
                                                        value="<?php echo e($Cate->soluong); ?>" placeholder="500" required="required">
                                                </div>
                                            </div>
                                            <!-- <div class="form-group row">
...
</html><?php /**PATH D:\Đại học\HK1_ Năm 4\Đồ án chuyên ngành\Lavarel\lavarel-app\resources\views/Admin/formD.blade.php ENDPATH**/ ?>